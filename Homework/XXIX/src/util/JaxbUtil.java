...
public class JaxbUtil {
    ...
    public static void modifyTriangles(String path) throws Exception{
        JAXBContext context = JAXBContext.newInstance(Triangles.class);
        
        Triangles triangles = (Triangles) context.createUnmarshaller().unmarshal(new File("data/triangles_input.xml"));
        ...
        serialize(triangles, "out/triangles_output.xml");

        context.generateSchema(new SchemaOutputResolver() {
            @Override
            public Result createOutput(String namespaceUri, String suggestedFileName) throws IOException {
                StreamResult result = new StreamResult(new File("data/triangles.xsd"));
                result.setSystemId("data/triangles.xsd");
                return result;
            }
        });
    }
