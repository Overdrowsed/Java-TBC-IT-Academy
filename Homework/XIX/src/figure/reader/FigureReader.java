...
public class FigureReader {
    ...
    public static ArrayList<Circle> getCircleArrayListPrivateConstructor(){
        ...
        try (Scanner circleReader = new Scanner(new File(path))){
            while(circleReader.hasNextLine()){
                ...
                Constructor<Circle> circleConstructor = Circle.class.getDeclaredConstructor(int.class);
                circleConstructor.setAccessible(true);

                Circle circle = circleConstructor.newInstance(radius);
    ...
    public static ArrayList<Rectangle> getRectangleArrayListPrivateConstructor(){
        ...
        try (Scanner rectangleReader = new Scanner(new File(path))){
            while(rectangleReader.hasNextLine()){
                ...
                Constructor<Rectangle> rectangleConstructor = Rectangle.class.getDeclaredConstructor(int.class, int.class);
                rectangleConstructor.setAccessible(true);
                
                Rectangle rectangle = rectangleConstructor.newInstance(width, height);
    ...
    public static ArrayList<Triangle> getTriangleArrayListPrivateConstructor(){
        ...
        try (Scanner triangleReader = new Scanner(new File(path))){
            while(triangleReader.hasNextLine()){
                ...
                Constructor<Triangle> triangleConstructor = Triangle.class.getDeclaredConstructor(int.class, int.class, int.class);
                triangleConstructor.setAccessible(true);
                
                Triangle triangle = triangleConstructor.newInstance(sideA, sideB, sideC);
